...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 5e+07, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe35(net_slot_1_axi_ar_cnt),
        .probe36(net_slot_1_axi_araddr),
        .probe37(net_slot_1_axi_arprot),
        .probe38(net_slot_1_axi_aw_cnt),
        .probe39(net_slot_1_axi_awaddr),
        .probe4(net_slot_0_axi_arcache),
        .probe40(net_slot_1_axi_awprot),
        .probe41(net_slot_1_axi_b_cnt),
        .probe42(net_slot_1_axi_bresp),
        .probe43(net_slot_1_axi_r_cnt),
        .probe44(net_slot_1_axi_rdata),
        .probe45(net_slot_1_axi_rresp),
        .probe46(net_slot_1_axi_wdata),
        .probe47(net_slot_1_axi_wstrb),
        .probe48(net_slot_1_axi_aw_ctrl),
        .probe49(net_slot_1_axi_w_ctrl),
        .probe5(net_slot_0_axi_arid),
        .probe50(net_slot_1_axi_b_ctrl),
        .probe51(net_slot_1_axi_ar_ctrl),
        .probe52(net_slot_1_axi_r_ctrl),
        .probe53(net_slot_2_axi_ar_cnt),
        .probe54(net_slot_2_axi_araddr),
        .probe55(net_slot_2_axi_arcache),
        .probe56(net_slot_2_axi_arlen),
        .probe57(net_slot_2_axi_arprot),
        .probe58(net_slot_2_axi_arsize),
        .probe59(net_slot_2_axi_aw_cnt),
        .probe6(net_slot_0_axi_arlen),
        .probe60(net_slot_2_axi_awaddr),
        .probe61(net_slot_2_axi_awcache),
        .probe62(net_slot_2_axi_awlen),
        .probe63(net_slot_2_axi_awprot),
        .probe64(net_slot_2_axi_awsize),
        .probe65(net_slot_2_axi_b_cnt),
        .probe66(net_slot_2_axi_r_cnt),
        .probe67(net_slot_2_axi_rdata),
        .probe68(net_slot_2_axi_rresp),
        .probe69(net_slot_2_axi_wdata),
        .probe7(net_slot_0_axi_arlock),
        .probe70(net_slot_2_axi_aw_ctrl),
        .probe71(net_slot_2_axi_w_ctrl),
        .probe72(net_slot_2_axi_b_ctrl),
        .probe73(net_slot_2_axi_ar_ctrl),
        .probe74(net_slot_2_axi_r_ctrl),
