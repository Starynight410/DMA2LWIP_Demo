...
HD_PWD='F:/Boards/mz7x/fdma_dbuf_lwip_daq4225/zu_prj/uisrc/03_ip/uifdmadbuf/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uifdma_dbuf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uifdma_dbuf.tcl
